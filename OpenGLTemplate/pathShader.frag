...
uniform SpotLightInfo spotlights [8];
...
void main()
{
	...
	//	{
	//		vColour = vColour + BlinnPhongSpotlightModel(spotlights[i] , p , normalize(n));
	//	}
	//}
	vColour = vColour + BlinnPhongSpotlightModel(spotlights[7] , p , normalize(n));
